...
// This is a modified version of endianness.h from https://github.com/crashoz/uuid_v4
  ...
  #define letobe256(x) x
    ...
    #define betole32(x) x
    #define betole64(x) x
    #define letobe64(x) _bswap64(x)
    #define letobe32(x) _bswap(x)
    #define letobe16(x) _bswap16(x)
  #elif defined(__GNUC__)
    #define betole16(x) x
    #define betole32(x) x
    #define betole64(x) x
    #define letobe64(x) __builtin_bswap64(x)
    #define letobe32(x) __builtin_bswap32(x)
    #define letobe16(x) __builtin_bswap16(x)
  #elif defined(_MSC_VER)
    #include <stdlib.h>
    #define betole16(x) x
    #define betole32(x) x
    #define betole64(x) x
    #define letobe64(x) _byteswap_uint64(x)
    #define letobe32(x) _byteswap_ulong(x)
    #define letobe16(x) _byteswap_ushort(x)
  #else
    #define FALLBACK_SWAP
    #define betole16(x) x
    #define betole32(x) x
    #define betole64(x) x
    #define letobe64(x) swap_u64(x)
    #define letobe32(x) swap_u32(x)
    #define letobe16(x) swap_u16(x)
  #endif
...
#if defined(__INTEL_COMPILER) || defined(__ICC)
  #define forceswap16(x) _bswap16(x)
  #define forceswap32(x) _bswap(x)
  #define forceswap64(x) _bswap64(x)
#elif defined(__GNUC__)
  #define forceswap16(x) __builtin_bswap16(x)
  #define forceswap32(x) __builtin_bswap32(x)
  ...
  #define forceswap32(x) swap_u32(x)
  #define forceswap64(x) swap_u64(x)
#endif
